...
export const AdminSettings: React.FC = () => {
  ...
  return (
    <div className="bg-white border border-[#D8D8D8]/80 rounded-3xl p-6 sm:p-8 space-y-6 shadow-[0_4px_25px_-4px_rgba(50,50,50,0.02)] max-w-2xl animate-fade-in">
      ...
      <div className="bg-[#FFFFFF] rounded-2xl border border-[#D8D8D8]/40 p-5 mt-4 space-y-6">
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-[#737373] leading-relaxed max-w-md">
          ...
          >
            {emailNotificationsEnabled ? (
              ...
              <ToggleLeft className="w-12 h-12 text-[#737373]/40" />
            )}
          </button>
        </div>

        <div className="pt-4 border-t border-[#D8D8D8]/30 flex items-center justify-between text-[11px]">
          <span className="text-brand-chocolate/70 font-mono">Simulated Target:</span>
          <span className="bg-white px-2.5 py-1 rounded-md border border-[#D8D8D8]/50 font-mono text-brand-dark font-semibold">
      ...
      {/* How-to test guide */}
      <div className="border border-[#D8D8D8]/50 rounded-2xl p-5 space-y-3 bg-[#FFFFFF]/40 text-xs">
        <h4 className="font-serif font-bold text-brand-dark">How to test this trigger:</h4>
        <ol className="list-decimal pl-4 space-y-1.5 text-[#737373] leading-relaxed text-[11px]">
          <li>
